...
_lr_productions = [
  ...
  ('constDecl',3,'p_constDecl','analizadorSintactico.py',32),
  ('constDecl',1,'p_constDeclEmpty','analizadorSintactico.py',37),
  ('constAssignmentList',3,'p_constAssignmentList1','analizadorSintactico.py',42),
  ('constAssignmentList',5,'p_constAssignmentList2','analizadorSintactico.py',46),
  ('varDecl',3,'p_varDecl1','analizadorSintactico.py',50),
  ('varDecl',1,'p_varDeclEmpty','analizadorSintactico.py',54),
  ('identList',1,'p_identList1','analizadorSintactico.py',58),
  ('identList',3,'p_identList2','analizadorSintactico.py',62),
  ('procDecl',6,'p_procDecl1','analizadorSintactico.py',66),
  ('procDecl',1,'p_procDeclEmpty','analizadorSintactico.py',70),
  ('statement',3,'p_statement1','analizadorSintactico.py',74),
  ('statement',2,'p_statement2','analizadorSintactico.py',78),
  ('statement',3,'p_statement3','analizadorSintactico.py',82),
  ('statement',4,'p_statement4','analizadorSintactico.py',86),
  ('statement',4,'p_statement5','analizadorSintactico.py',90),
  ('statement',1,'p_statementEmpty','analizadorSintactico.py',94),
  ('statementList',1,'p_statementList1','analizadorSintactico.py',98),
  ('statementList',3,'p_statementList2','analizadorSintactico.py',102),
  ('condition',2,'p_condition1','analizadorSintactico.py',106),
  ('condition',3,'p_condition2','analizadorSintactico.py',110),
  ('relation',1,'p_relation1','analizadorSintactico.py',114),
  ('relation',1,'p_relation2','analizadorSintactico.py',118),
  ('relation',1,'p_relation3','analizadorSintactico.py',122),
  ('relation',1,'p_relation4','analizadorSintactico.py',126),
  ('relation',1,'p_relation5','analizadorSintactico.py',130),
  ('relation',1,'p_relation6','analizadorSintactico.py',134),
  ('expression',1,'p_expression1','analizadorSintactico.py',138),
  ('expression',2,'p_expression2','analizadorSintactico.py',142),
  ('expression',3,'p_expression3','analizadorSintactico.py',146),
  ('addingOperator',1,'p_addingOperator1','analizadorSintactico.py',150),
  ('addingOperator',1,'p_addingOperator2','analizadorSintactico.py',154),
  ('term',1,'p_term1','analizadorSintactico.py',158),
  ('term',3,'p_term2','analizadorSintactico.py',162),
  ('multiplyingOperator',1,'p_multiplyingOperator1','analizadorSintactico.py',166),
  ('multiplyingOperator',1,'p_multiplyingOperator2','analizadorSintactico.py',170),
  ('factor',1,'p_factor1','analizadorSintactico.py',174),
  ('factor',1,'p_factor2','analizadorSintactico.py',178),
  ('factor',3,'p_factor3','analizadorSintactico.py',182),
  ('empty',0,'p_empty','analizadorSintactico.py',186),
]
